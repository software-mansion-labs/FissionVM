...
-export([format/2, fwrite/2, latin1_char_list/1, write_atom/1, write_atom_as_latin1/1, deep_char_list/1,write/1,write/2,write/3, write_binary/3,write_string/1, quote_atom/2, write_char/1]).
