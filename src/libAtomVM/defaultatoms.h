...
#define ENV_ATOM_INDEX 117

#define POSITIVE_ATOM_INDEX 118
#define MONOTONIC_ATOM_INDEX 119

#define REGISTERED_NAME_ATOM_INDEX 120

// Defines the first index for platform specific atoms, should always be last in the list
#define PLATFORM_ATOMS_BASE_INDEX 121
...
#define ENV_ATOM TERM_FROM_ATOM_INDEX(ENV_ATOM_INDEX)

#define POSITIVE_ATOM TERM_FROM_ATOM_INDEX(POSITIVE_ATOM_INDEX)
#define MONOTONIC_ATOM TERM_FROM_ATOM_INDEX(MONOTONIC_ATOM_INDEX)

#define REGISTERED_NAME_ATOM TERM_FROM_ATOM_INDEX(REGISTERED_NAME_ATOM_INDEX)
